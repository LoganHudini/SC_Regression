...
export class ActivityDetailDrawerPage {
  ...
  constructor(page: Page) {
    ...
    this.datePicker = page.locator('//p[text()="Date"]/following-sibling::div[contains(@class,"rmc-multi-picker")]//div[contains(@class,"rmc-picker-item")]');
    ...
    this.activityCategory = (categoryName) => 
      page.locator('//p[@class="activity_name__Or0uD globals-activityTitle"]').filter({ hasText: categoryName });
    this.activityItem = (activityName) =>
      page.locator('//h2[@class="ListComponents_listComponentTitle__IWRAf globals-text-align"]').filter({ hasText: activityName });
    ...
    this.activitiesContainer = page.locator('//span[@class="activityAndItinerary_cardTitle__Eaz_g"]');
    
    // Time picker locators
    this.activityHours = page.locator('(//p[text()="Start Time"]/following-sibling::div//div[@class="rmc-picker"])[1]//div[contains(@class, "rmc-picker-item-selected")]');
    this.activityMinutes = page.locator('(//p[text()="Start Time"]/following-sibling::div//div[@class="rmc-picker"])[2]//div[contains(@class, "rmc-picker-item-selected")]');
    this.activityAMPM = page.locator('(//p[text()="Start Time"]/following-sibling::div//div[@class="rmc-picker"])[3]//div[contains(@class, "rmc-picker-item-selected")]');
  }
  ...
  async logAndClickFirstCategory() {
    const categories = this.page.locator('//p[@class="activity_name__Or0uD globals-activityTitle"]');
...
async selectCategory(categoryName?: string) {
  ...
  const categoryElements = this.page.locator('//p[@class="activity_name__Or0uD globals-activityTitle"]');
  ...
  const activitiesLocator = this.page.locator('//h2[@class="ListComponents_listComponentTitle__IWRAf globals-text-align"]');
  ...
  async selectFirstActivity() {
    const activities = this.page.locator('//h2[@class="ListComponents_listComponentTitle__IWRAf globals-text-align"]');
  ...
  async bookActivity(activityDetails: {
    ...
    await this.page.waitForSelector('(//p[text()="Start Time"]/following-sibling::div//div[@class="rmc-picker"])[1]//div[contains(@class, "rmc-picker-item-selected")]');
...
const datePickerContainer = this.page.locator('//p[text()="Date"]/following-sibling::div[contains(@class,"rmc-multi-picker")]');
...
return {
  ...
  async verifyBookedActivityInItinerary(): Promise<boolean> {
    try {
      await this.page.waitForURL('https://fairmont.hudinielevate-stage.io/en/fairmont-mumbai/itinerary/', { timeout: 30000 });
