  ...
  return (
    <>
      <div className={styles.bottomMenuWrapper}>
        ...
        <Link
          className={styles.bottomMenuLink}
          href={checkinData?.checkedIn ? availablePaths?.HOUSEKEEPING : availablePaths?.CHECK_IN}
          onClick={toggleAllMenuDisplayed}
        >
          <div
            className={cx(styles.bottomMenuLinkInner, {
        ...
        <Link
          className={styles.bottomMenuLink}
          href={checkinData?.checkedIn ? availablePaths?.CHAT : availablePaths?.CHECK_IN}
          onClick={toggleAllMenuDisplayed}
        >
          <div
            className={cx(styles.bottomMenuLinkInner, {
          ...
          >
            <div className={styles.bottomMenuLinkIconWrapper}>
              {chatActive ? <ChatActiveIcon /> : <ChatIcon />}
            </div>
