...
const Preferences = () => {
    ...
    return (
        <>
            <Header
                screenTitle={(t('Preferences') as string)}
                displayHome
            />

            <PageWrapper className={styles.pageWrapper} >

                {hotelImages && <StableImage
                    className={styles.image}
                    src={`${ASSETS_URL}/${hotelImages?.master}`}
                />}

                <div className={styles.wrapper} >
                    <div className={styles.title}>{
                        imageDetails.title}</div>
                                            ...
                                            {category?.type === YESNO &&
                                                <div
                                                    ...
                                                    className={cx(styles.button, {
                                                        [styles.buttonSelected]: selectedOptions[preference.pageTitle]?.includes(category.title),
                                                    })}
                                                >
                                                    {category.title}
                                                </div>
